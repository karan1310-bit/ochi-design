    ...
    <div className="w-full h-screen bg-zinc-900 pt-1">
      <div className="mt-44 px-8 md:px-16">
        {["We Create", "Eye-Opening", "Presentations"].map((text, index) => (
          <div className='masker'><div className='flex items-center w-fit overflow-hidden'>
            {index === 1 && (
              <div className='mr-[1vw] w-[7vw] h-[8vh] rounded-md relative bg-green-500'></div>
            )}
          <h1
            key={index}
      ...
      <div className="border-t-[1px] border-zinc-800 mt-64 md:mt-24 flex flex-col md:flex-row md:justify-between gap-6 md:items-center py-8 px-6 md:px-20">
        {[
